...
//////////////////////////////////////////////////////////////////////////////
//Create stack for "memory"
M._stack = [];

// Set m values to identity matrix.
M.identity  = function(m) {
  if(m.length > 0 ){
    M.matrixMultiply(m, M.identityMatrix(), m);
  }
...
//matrix multiplication of m and the (x,y,z,w) point of v
